...
class DesignSystemGenerator:
    ...
    def generate(self, query: str, project_name: str = None) -> dict:
        ...
        return {
            ...
            "colors": {
                "primary": best_color.get("Primary (Hex)", "#301A2F"),
                "secondary": best_color.get("Secondary (Hex)", "#6B5B9E"),
                "cta": best_color.get("CTA (Hex)", "#301A2F"),
                "background": best_color.get("Background (Hex)", "#fbfaff"),
                "text": best_color.get("Text (Hex)", "#1a1a1f"),
